# TodoList - Enterprise Task Management System
...
│  │  (IToDoList, ToDoItemMapper, Models)             │  │
│  └──────────────────────────────────────────────────┘  │
└─────────────────────────────────────────────────────────┘
                          ↓
┌─────────────────────────────────────────────────────────┐
...
│  │  (ToDoListService, Validation Rules)             │  │
│  └──────────────────────────────────────────────────┘  │
└─────────────────────────────────────────────────────────┘
                          ↓
┌─────────────────────────────────────────────────────────┐
...
│  │  (ITodoListRepository, In-Memory Storage)        │  │
│  └──────────────────────────────────────────────────┘  │
└─────────────────────────────────────────────────────────┘
```
...
│   ├── IToDoList.cs
│   ├── IToDoItemMapper.cs
│   └── IProgressionMapper.cs
│
├── ToDoList.Application.Impl/         # 📦 Application Implementation
│   └── ToDoListService.cs
│
├── ToDoList.Application.Models/       # 📦 DTOs
│   ├── CreateRequest.cs
│   ├── UpdateRequest.cs
│   └── RegisterProgressionRequest.cs
│
├── ToDoList.Domain.Contracts/         # 🔷 Domain Interfaces
│
├── ToDoList.Domain.Impl/              # 🔷 Domain Implementation
│   └── ToDoListService.cs
│
├── ToDoList.Domain.Models/            # 🔷 Domain Models
│   ├── ToDoItem.cs
│   └── Progression.cs
│
├── ToDoListRepository/                # 💾 Data Access Layer
│   └── TodoListRepository.cs
│
├── ToDoList.Domain.Test/              # 🧪 Unit Tests
...
- **TodoList.Tests** - Integration tests
...
- Built with ASP.NET Core and .NET 6
